...
namespace AlgorithmPractice.Codility.Lessons.Indeed2015Challenge
{
    public class LongestPassword
    {
        ...
        Note that neither "test" nor "?xy1" is a valid password, because "?" is not an 
        alphanumerical character and "test" contains an even number of digits (zero).
        ...
        public static int Solution(String S)
        {
            ...
            foreach (var w in words)
            {
                ...
                if (numberCnt % 2 == 1 && charCnt % 2 == 0 && w.Length > longestNumber)
                    longestNumber = w.Length;
            }
