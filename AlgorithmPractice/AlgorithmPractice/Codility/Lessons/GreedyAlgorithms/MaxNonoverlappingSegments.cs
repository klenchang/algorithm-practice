...
namespace AlgorithmPractice.Codility.Lessons.GreedyAlgorithms
{
    public class MaxNonoverlappingSegments
    {
        ...
        whose positions are given in arrays A and B. For each I (0 ≤ I < N) the position of 
        segment I is from A[I] to B[I] (inclusive). 
        The segments are sorted by their ends, 
