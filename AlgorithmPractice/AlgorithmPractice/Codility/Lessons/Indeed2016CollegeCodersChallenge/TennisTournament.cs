...
namespace AlgorithmPractice.Codility.Lessons.Indeed2016CollegeCodersChallenge
{
    public class TennisTournament
    {
        #region topic
        /*
        You are hosting a tennis tournament. P players, who will take part in the first 
        ...
        can be played on each court at any given time.
        ...
        Examples:
        1. Given P = 5 players and C = 3 available courts, 
        the function should return 2. 
        Two games can be played simultaneously 
        (for instance, the first and second players can play on the first court, 
        and the third and fourth players on the second court, 
        and the third court will be empty because the fifth player does not have a 
